...
<body>
	...
	<br><center><h2>PERBAHARUI DATA PASIEN</h2></center>
	<br/>
    <?php
    include '../koneksi.php';
    $id = $_GET['id'];
        ...
        <form method="post" action="update.php" class="form1">
            <table align="center" style="text-align: left;">
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="radio" name="jenis_kelamin" value="L" <?php if($d['jenis_kelamin']=='L') echo 'checked'?>>L
                        </label>
                        <label>
                            <input type="radio" name="jenis_kelamin" value="P" <?php if($d['jenis_kelamin']=='P') echo 'checked'?>>P
                        </label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><a href="pasien.php" class="button">Kembali</a></td>
