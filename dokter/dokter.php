...
<body>
	...
	<br><center><h2>DATA DOKTER</h2></center>
	<br/>
	<table border="1" class="table1">
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit_dokter.php?id=<?php echo $d['id_dokter']; ?>">EDIT</a>
					<a href="hapus.php?id=<?php echo $d['id_dokter']; ?>">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
	...
	<br/>
	<center><button class="button"><a href="tambah.php" class="link">TAMBAH DOKTER</a></button></center>
